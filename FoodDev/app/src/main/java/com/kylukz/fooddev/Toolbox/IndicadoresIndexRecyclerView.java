 ...
 */
public class IndicadoresIndexRecyclerView extends RecyclerView.ItemDecoration {
    ...
    public IndicadoresIndexRecyclerView() {
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        float indicatorPosY = parent.getHeight() - mIndicatorHeight / 2.5F;
     ...
     private void drawInactiveIndicators(Canvas c, float indicatorStartX, float indicatorPosY, int itemCount) {
         ...
         mPaint.setColor(Color.rgb(108, 0, 0));
     ...
     private void drawHighlights(Canvas c, float indicatorStartX, float indicatorPosY, int highlightPosition, float progress, int itemCount) {
         mPaint.setColor(Color.rgb(251, 176, 0));
